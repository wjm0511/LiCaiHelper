 ...
 */
public class ShouruKmActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goSZView("incomesubject",shouruSubjects);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShouruKmActivity.this.finish();
            }
        });
    }
    ...
    public void goSZView(final String tableName,String[] kemu){
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(al.contains(str))
                    Toast.makeText(ShouruKmActivity.this,"不能重复插入",Toast.LENGTH_SHORT).show();
                else if(str.length()==0)
                    Toast.makeText(ShouruKmActivity.this,"输入框不能为空",Toast.LENGTH_SHORT).show();
                else {
    ...
    private void setAdapter(final ListView lv,final List<String> al, final String tableName){
        final BaseAdapter baseAdapter=new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                View view= LayoutInflater.from(ShouruKmActivity.this).inflate(R.layout.shourukemulist,null);
                ...
                deleteBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        new AlertDialog.Builder(ShouruKmActivity.this)
                                .setTitle("删除")
                                .setMessage("确认删除科目"+"\""+del_str+"\"?")
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        DBUtil.deleteFromTable(del_str,"incomesubject");
                                        al.remove(del_str);
                                        setAdapter(lv, al, tableName);
                                    }
                                })
