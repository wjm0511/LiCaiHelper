 ...
 */
public class DEBXDetailActivity extends Activity {
        ...
        back.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DEBXDetailActivity.this.finish();
                    }
                }
        );
        ListView datailLv = (ListView) findViewById(R.id.ListView01);
        datailList = DBUtil.getDetail("dengebenxidetail");
        if(datailList.size()!=0){
            setListAdapter(datailLv, datailList);
        }else
            Toast.makeText(DEBXDetailActivity.this,"木有数据的啦！",Toast.LENGTH_SHORT).show();
    ...
    private  void setListAdapter(final ListView lv,final List<String[]> bl){
        BaseAdapter ba=new BaseAdapter(){
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                View view= LayoutInflater.from(DEBXDetailActivity.this).inflate(R.layout.detaillsit1,null);
