package com.example.wjm.licaihelper.bianqian;
...
import com.example.wjm.licaihelper.NotesDB;
...
public class AtyEditNote extends ListActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btnSave: //保存按钮
                    //保存多媒体信息和笔记到数据库，然后关闭页面，返回到笔记列表页面
                    saveMedia(saveNote());
                    setResult(RESULT_OK);
                    finish();
                    break;
    ...
    static class MediaAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ivIcon.setImageBitmap(data.iconId);
